...
const replyer = (data, upsert) => {
    ...
    for (const msg of upsert.messages) {
        if (!msg.key.fromMe && doReplies) {
            ...
            const message = ((type == 'conversation' || type == 'notify') && msg.message.conversation) ? msg.message.conversation : (type == 'imageMessage' && msg.message.imageMessage.caption) ? msg.message.imageMessage.caption : (type == 'documentMessage' && msg.message.documentMessage.caption) ? msg.message.documentMessage.caption : (type == 'videoMessage' && msg.message.videoMessage.caption) ? msg.message.videoMessage.caption : (type == 'extendedTextMessage' && msg.message.extendedTextMessage.text) ? msg.message.extendedTextMessage.text : (type == 'buttonsResponseMessage' && msg.message.buttonsResponseMessage.selectedButtonId) ? msg.message.buttonsResponseMessage.selectedButtonId : (type == 'templateButtonReplyMessage') && msg.message.templateButtonReplyMessage.selectedId ? msg.message.templateButtonReplyMessage.selectedId : ''
...
Platform: ${conn.authState.creds.platform}`
                ...
                case prefix + 'mention':
                    ...
                    var text = `That's is the mention!`
                    var isReply = true
                    var reply = true
                    break;
                case prefix + 'groups':
