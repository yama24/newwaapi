const { delay, downloadMediaMessage } = require("@adiwajshing/baileys")
...
const replyer = async (data, upsert) => {
    ...
    for (const msg of upsert.messages) {
        ...
        if (messageType === 'imageMessage') {
            ...
            // save to file
            if (!fs.existsSync('./DOWNLOADED_MEDIA/')) {
                fs.mkdirSync('./DOWNLOADED_MEDIA/');
            }        
            await writeFile('./DOWNLOADED_MEDIA/tes.jpg', buffer)
        }
